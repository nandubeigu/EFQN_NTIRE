...
def select_model(args, device):
    ...
    if model_id == 0:
        ...
        # Original Code: https://github.com/bytedance/RLFN
        # Ckpts: rlfn_ntire_x4.pth
        from models.team01_EFQN import QuickSRNetLarge
        name, data_range = f"{model_id:02}_EFQN", 1.0
        model_path = os.path.join('model_zoo', 'team01_EFQN.pt')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", default="/root/autodl-tmp/NTIRE2024_ESR-main/dataset", type=str)
